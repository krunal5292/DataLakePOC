...
/**
 * Manual test for Buyer Data Fetch API using Iceberg strategy.
 * 
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        ...
        // Skip backlog
        "gold.group.id=gold-group-manual-buyer-iceberg",
        "spring.kafka.consumer.auto-offset-reset=latest"
})
public class BuyerDataFetchIcebergManualTest {
    ...
    void testBuyerFetchesOnlyConsentedDataFromIceberg() throws Exception {
        ...
        // 4. Wait for Iceberg table creation and data processing using
        // strategy.verifyDataExists
        System.out.println("⏳ Waiting for Iceberg table creation and processing...");

        await().atMost(90, TimeUnit.SECONDS).pollInterval(3, TimeUnit.SECONDS).untilAsserted(() -> {
    ...
    void testIcebergPartitionPruning() throws Exception {
        ...
        await().atMost(90, TimeUnit.SECONDS).pollInterval(3, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(dataExists).as("Iceberg gold layer should have data for healthAndMedical purpose").isTrue();
        });
