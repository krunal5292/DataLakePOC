...
public class SilverEnrichmentProcessor {
    ...
    public SilverEnrichmentProcessor(SilverService silverService,
            KafkaTemplate<String, TelemetryMessage> kafkaTemplate) {
        this.silverService = silverService;
        this.kafkaTemplate = kafkaTemplate;
    }

    @KafkaListener(topics = KafkaConfig.TELEMETRY_BRONZE_SAVED, groupId = "${spring.kafka.consumer.group-id.silver:silver-group}")
